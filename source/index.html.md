...
**surname** <br> <font color="#939da3">sring, *optional*</font> | Фамилия клиента.
...
**cart_items** <br> <font color="#939da3">object, *optional*</font> | Объект, содержащий информацию о заказе.
**sku** <br> <font color="#939da3">string, *optional*</font> | Складская учётная единица (stock keeping unit).
**name** <br> <font color="#939da3">string</font> | Наименование товара.
...
<font color="green"> POST </font> `BASE_URL/factoring/v1/precheck/change`
