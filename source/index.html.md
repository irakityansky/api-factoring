...
Кейс регистрации клиента:

1. Заполнение анкеты
2. Переход на экран подтверждения номера телефона кодом из смс-сообщения <br>
2.1 Если клиент ввел некорректно свой номер, то переходит на iframe с вводом номера телефона и нажимает кнопку "Отправить смс" <br>
3. Отображение экрана результата:<br>
3.1 Отображение окна с результатом "Оформление прошло успешно" и информацией о доступном лимите.<br>
3.2 Отображение окна с результатом "К сожалению, 'Оплата частями' Вам недоступна"<br>
...
4. Нажатие кнопки Войти на первой странице iframe
5. Ввод мобильного номера и Нажатие кнопки "Отправить СМС":
5.1 Если мобильный номер не существует в базе Рево, клиент переходит на окно с информационным сообщением "С указанным номером телефона мы Вас не нашли"
5.2 Если мобильный номер существует в базе Рево, клиент переходит на экран Подтверждение мобильного номера кодом из смс-сообщения.
6. Клиент ввел не свой номер телефона, то на экране "Подтверждения мобильного номера кодом из смс-сообщения", клиент может изменить номер телефона нажав на него ниже:
6.1 Клиент переходит на экран с вводом другого номера телефона и нажимает кнопку "Отправить СМС"
6.2 Клиент переходит на экран с "Подтверждением мобильного номера кодом из смс-сообщения", вводит смс и нажимает кнопку "Подтвердить"
7. Отображение окна результата в iframe Клиенту
7.1 Отображение окна результата с информацией "Оформление прошло успешно" и информацией о доступном лимите.
7.2 Отображение окна результата с информацией "К сожалению, 'Оплата частями' Вам недоступна".
