...
:-|:-|:-
**1. Кейс checkout > frame > finish успешное оформление** |
Отправить запрос с помощью метода <a href="#checkout">checkout</a> | Получить ссылку на вызов iframe| status: Pending; decision: null
