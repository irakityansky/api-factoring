...
> Описание процесса Регистрации клиента API Registration
Кейс регистрации клиента:

 >1. Заполнение анкеты
 2. Переход на экран подтверждения номера телефона кодом из смс-сообщения
 2.1 Если клиент ввел некорректно свой номер, то переходит на iframe с вводом номера телефона и нажимает кнопку "Отправить смс"
 ...
 3.2 Отображение окна с результатом "К сожалению, 'Оплата частями' Вам недоступна"
